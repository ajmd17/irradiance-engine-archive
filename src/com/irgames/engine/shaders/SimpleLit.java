 ...
 * @author Xoppa
 */
public class SimpleLit extends LightShader {
    ...
    @Override
    public void init() {
        String vert = Gdx.files.internal("data/shaders/simplelit/simplelit.vertex.glsl").readString();
    ...
    public void render(Renderable renderable) {
        ...
        if (this.irmat.getBoolean("debugView") != null) {
            if (this.irmat.getBoolean("debugView") == true) {
                program.setUniformi("u_debugView", 1);
            } else if (this.irmat.getBoolean("debugView") == false) {
                program.setUniformi("u_debugView", 0);
            }
        } else {
            program.setUniformi("u_debugView", 0);
        }
