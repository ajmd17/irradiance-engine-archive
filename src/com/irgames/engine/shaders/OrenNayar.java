 ...
 * @author Xoppa
 */
public class OrenNayar extends LightShader {
    ...
    @Override
    public void init() {
        String vert = Gdx.files.internal("data/shaders/oren_nayar/oren_nayar.vertex.glsl").readString();
        String frag = Gdx.files.internal("data/shaders/oren_nayar/oren_nayar.fragment.glsl").readString();
