...
public class WaterShader extends LightShader {
    ...
    public void init() {
         ...
         */
        String vert = Gdx.files.internal("data/shaders/water/water.vert.glsl").readString();
        String frag = Gdx.files.internal("data/shaders/water/water.frag.glsl").readString();
    ...
    public void render(Renderable renderable
        ...
        program.setUniformf("u_textureScale", 2.0f);
