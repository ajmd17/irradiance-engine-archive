 ...
 * @author Xoppa
 */
public class NewDepthShader_Leaves extends LightShader {
    ...
    public NewDepthShader_Leaves() {

    }

    @Override
    public void init() {
        String vert = Gdx.files.internal("data/shaders/depth/irdepth_leaves.vertex.glsl").readString();
        String frag = Gdx.files.internal("data/shaders/depth/irdepth_leaves.fragment.glsl").readString();
