 ...
 * ShaderPogram, you are still responsible for disposing the ShaderProgram.
 */
public abstract class BaseShader implements Shader {
    ...
    public interface Validator {
        ...
        /**
         * @return True if the input is valid for the renderable, false
         * otherwise.
         */
    ...
    public interface Setter {
        ...
        /**
         * @return True if the uniform only has to be set once per render call,
         * false if the uniform must be set for each renderable.
         */
    ...
    /**
     * Register an uniform which might be used by this shader. Only possible
     * prior to the call to init().
     *
    ...
    public void render(Renderable renderable, final Attributes combinedAttributes) {
        ...
        //if (irmat != null) {
            ...
            if (diffuseTex != null) {
                ...
                program.setUniformi("u_useDiffuse", 1);
            } else {
                program.setUniformi("u_useDiffuse", 0);
            }
        //}
