 ...
 * @author Xoppa
 */
public class NormalsShader extends IRShader {
    ...
    @Override
    public void init() {
        String vert = Gdx.files.internal("data/shaders/deferred/normals.vertex.glsl").readString();
        String frag = Gdx.files.internal("data/shaders/deferred/normals.fragment.glsl").readString();
