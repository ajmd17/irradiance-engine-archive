...
public class AnimBatch implements Disposable {
	...
	public AnimBatch (final RenderContext context, final ShaderProvider shaderProvider, final RenderableSorter sorter) {
		...
		this.shaderProvider = (shaderProvider == null) ? new AnimShaderProvider() : shaderProvider;
	}

	/** Construct a ModelBatch, using this constructor makes you responsible for calling context.begin() and context.end() yourself.
	 * @param context The {@link RenderContext} to use.
	 * @param shaderProvider The {@link ShaderProvider} to use, will be disposed when this ModelBatch is disposed. */
	public AnimBatch (final RenderContext context, final ShaderProvider shaderProvider) {
	 ...
	 * @param context The {@link RenderContext} to use.
	 * @param sorter The {@link RenderableSorter} to use. */
	public AnimBatch (final RenderContext context, final RenderableSorter sorter) {
		this(context, null, sorter);
	}

	/** Construct a ModelBatch, using this constructor makes you responsible for calling context.begin() and context.end() yourself.
	 * @param context The {@link RenderContext} to use. */
	public AnimBatch (final RenderContext context) {
	 ...
	 * @param shaderProvider The {@link ShaderProvider} to use, will be disposed when this ModelBatch is disposed.
	 * @param sorter The {@link RenderableSorter} to use. */
	public AnimBatch (final ShaderProvider shaderProvider, final RenderableSorter sorter) {
		this(null, shaderProvider, sorter);
	}

	/** Construct a ModelBatch
	 * @param sorter The {@link RenderableSorter} to use. */
	public AnimBatch (final RenderableSorter sorter) {
		this(null, null, sorter);
	}

	/** Construct a ModelBatch
	 * @param shaderProvider The {@link ShaderProvider} to use, will be disposed when this ModelBatch is disposed. */
	public AnimBatch (final ShaderProvider shaderProvider) {
	...
	public AnimBatch (final FileHandle vertexShader, final FileHandle fragmentShader) {
		this(null, new AnimShaderProvider(vertexShader, fragmentShader), null);
	}
	...
	public AnimBatch (final String vertexShader, final String fragmentShader) {
		this(null, new AnimShaderProvider(vertexShader, fragmentShader), null);
	}
