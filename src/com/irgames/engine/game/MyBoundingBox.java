...
public class MyBoundingBox implements Serializable {
	...
	public MyBoundingBox (MyBoundingBox bounds) {
		this.set(bounds);
	}
	...
	public MyBoundingBox (Vector3 minimum, Vector3 maximum) {
	...
	public MyBoundingBox set (MyBoundingBox bounds) {
	 ...
	 * @param maximum The maximum vector
	 * @return This bounding box for chaining. */
	public MyBoundingBox set (Vector3 minimum, Vector3 maximum) {
	 ...
	 * @return This bounding box for chaining. */
	public MyBoundingBox set (Vector3[] points) {
		this.inf();
	 ...
	 * @param points The points.
	 * @return This bounding box for chaining. */
	public MyBoundingBox set (List<Vector3> points) {
		this.inf();
		for (Vector3 l_point : points)
			this.ext(l_point);
		return this;
	 ...
	 * @return This bounding box for chaining. */
	public MyBoundingBox ext (Vector3 point) {
	 ...
	 * @return This bounding box for chaining. */
	public MyBoundingBox ext (BoundingBox a_bounds) {
	 ...
	 * @return This bounding box for chaining. */
	public MyBoundingBox ext (MyBoundingBox bounds, Matrix4 transform) {
	 ...
	 * @return This bounding box for chaining. */
	public MyBoundingBox mul (Matrix4 transform) {
	...
	public boolean contains (MyBoundingBox b) {
		return !isValid()
	...
	public boolean intersects (MyBoundingBox b) {
	 ...
	 * @return This bounding box for chaining. */
	public MyBoundingBox ext (float x, float y, float z) {
