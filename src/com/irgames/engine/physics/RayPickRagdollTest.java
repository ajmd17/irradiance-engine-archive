...
public class RayPickRagdollTest extends BaseBulletTest {
	...
	public boolean touchDown (int screenX, int screenY, int pointer, int button) {
        ...
        public void render() {
            super.render();
            Gdx.graphics.setTitle(Gdx.graphics.getFramesPerSecond() + " FPS" + "    Mem: " + ((Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / (float) Runtime.getRuntime().totalMemory()) * 100f + "%");
	...
	protected Model createCapsuleModel (float radius, float height) {
        ...
        new LwjglApplication(new RayPickRagdollTest(), config);
    }
}